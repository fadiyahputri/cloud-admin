            ...
            <div class="no-padding portfolio_container clearfix" data-aos="fade-up">
              ...
              <div class="col-md-4 col-sm-6 PPLG">
                <div class="card card1">
                  <img class="main-img" src="assetsweb/assetsguru/assets-guru/how-to-be-teacher-malaysia-feature.png" alt="">
                  <img class="jurusan-rpl" src="assetsweb/assetsguru/assets-guru/rpl-overlay.png" alt="">
                  <h3>Pak Erraldo</h3>
                  <h5>Guru RPL</h5>
                  <span class="span-button"><button class="guru">Guru</button><button
    ...
    <section class="container-footer card-footer">
      ...
      <div class="table-footer">
        <div class="name-footer">
          <iconify-icon icon="mdi:about" style="color: #001953; margin: 1vh 1vh 0 0;" width="22"
            height="22"></iconify-icon>
          <p class="judul-footer">TENTANG</p>
        </div>
        <hr>
        <div class="button-footer">
          <button><a href=""><iconify-icon icon="dashicons:businessperson" style="color: white; margin-right: .2vw;"
                width="15" height="15"></iconify-icon>
              Kepala Sekolah</a></button>
          <button><a href=""><iconify-icon icon="material-symbols:push-pin"
                style="color: white; margin-right: .2vw;"" width=" 15" height="15"></iconify-icon>
              Visi dan Misi</a></button>
          <button><a href=""><iconify-icon icon="material-symbols:history-edu" style="color: white; margin-right: .2vw;"
                width="15" height="15"></iconify-icon>
              Sejarah</a></button>
          <button><a href=""><iconify-icon icon="eos-icons:admin-outlined" style="color: white; margin-right: .2vw;"
                width="15" height="15"></iconify-icon>
              Admin</a></button>
        </div>
      </div>
      ...
      <div class="table-footer">
        ...
        <hr>
        <div class="tahun">
          <iconify-icon icon="ic:round-navigate-next" style="color: #4BBBFA; cursor: pointer;" width="25" height="25"
            rotate="180deg"></iconify-icon>
          <h4>2022</h4>
          <iconify-icon icon="ic:round-navigate-next" style="color: #4BBBFA; cursor: pointer;" width="25"
      ...
      <div class="table-footer">
        ...
        <div class="info-footer">
          <a href="https://www.google.com/maps/place/SMKS+TARUNA+BHAKTI+DEPOK/@-6.3835979,106.8677466,17z/data=!3m1!4b1!4m5!3m4!1s0x2e69ebaff005f277:0x9fcd41028665eea8!8m2!3d-6.3836032!4d106.8699353"
            class="infoo-footer">Jl. Pekapuran, RT.02/RW.06, Curug, Cimanggis, Depok 16953</a>
        ...
        <div class="akunsosial-footer">
          <a href="https://www.instagram.com/starbhak.official/"><iconify-icon icon="mdi:instagram"
              style="color: #1E4A85; cursor: pointer;" width="20" height="20"></iconify-icon></a>
          <a href="https://www.youtube.com/c/SMKTarunaBhaktiDepok"><iconify-icon icon="mdi:youtube"
              style="color: #1E4A85; cursor: pointer;" width="20" height="20"></iconify-icon></a>
          <a href="https://www.facebook.com/smktarunabhaktidepok"><iconify-icon icon="mdi:facebook"
              style="color: #1E4A85; cursor: pointer;" width="20" height="20"></iconify-icon></a>
          <a href="https://www.tiktok.com/@smktarunabhakti"><iconify-icon icon="ic:baseline-tiktok"
              style="color: #1E4A85;  cursor: pointer;" width="20" height="20"></iconify-icon></a>
        </div>
      </div>
    </section>
